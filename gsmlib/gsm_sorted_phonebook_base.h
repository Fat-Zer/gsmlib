...
namespace gsmlib
{
  ...
  public:
    ...
    virtual iterator insert(const PhonebookEntryBase& x) = 0;
    virtual iterator insert(iterator position, const PhonebookEntryBase& x) = 0;
  ...
  public:
    ...
    virtual SortedPhonebookRef createPhonebook(std::string source) = 0;
  };
